<?php
$event = 'east';
$title = 'IndieWebCamp East';
$date = 'November 14-15, 2020';
$year = 2020;
$city = 'Online only';
$url = 'https://2020.indieweb.org/east';
$summary = 'IndieWebCamp East 2020 is an online gathering for independent web creators of all kinds, from graphic artists, to designers, UX engineers, coders, hackers, to share ideas, actively work on creating for their own personal websites, and build upon each others creations.';
...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment gold-bkg">
   ...
   <div class="ui vertical stripe segment" id="register">
    <div class="ui text container">
      ...
      <tito-widget event="indiewebcamp/iwc-east-2020"><a href="https://ti.to/indiewebcamp/iwc-east-2020">Get Tickets</a></tito-widget>
    </div>
  </div>
  ...
  <div class="ui inverted vertical footer segment gold-bkg">
    <div class="ui container">
      ...
      <ul>
        <li><a href="https://indieweb.org/2020/East">IndieWebCamp East wiki page</a></li>
